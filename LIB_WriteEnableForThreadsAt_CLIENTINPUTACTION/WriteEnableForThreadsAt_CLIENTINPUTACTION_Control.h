...
namespace OpenAvrilCLIDWriteEnableForThreadsAtCLIENTINPUTACTION
{
    ...
    public:
        ...
        ~WriteEnableForThreadsAt_CLIENTINPUTACTION_Control();
        void app_writeEnable_Activate(class WriteEnableForThreadsAt_CLIENTINPUTACTION_Framework* obj, uint8_t coreId);
        void app_writeEnable_SortQue(class WriteEnableForThreadsAt_CLIENTINPUTACTION_Framework* obj);
        void app_writeEnable_Request(class WriteEnableForThreadsAt_CLIENTINPUTACTION_Framework* obj, uint8_t coreId);
        void app_writeQue_Update(class WriteEnableForThreadsAt_CLIENTINPUTACTION_Framework* obj);
