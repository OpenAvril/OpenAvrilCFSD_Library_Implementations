...
// public.
	...
	// dynamic.
        void dyn_writeEnable_Activate(class WriteEnableForThreadsAt_CLIENTINPUTACTION_Framework* obj, uint8_t coreId);
        void dyn_writeEnable_SortQue(class WriteEnableForThreadsAt_CLIENTINPUTACTION_Framework* obj);
        void dyn_writeEnable_Request(class WriteEnableForThreadsAt_CLIENTINPUTACTION_Framework* obj, uint8_t coreId);
        void dyn_writeQue_Update(class WriteEnableForThreadsAt_CLIENTINPUTACTION_Framework* obj);
        // create.    
