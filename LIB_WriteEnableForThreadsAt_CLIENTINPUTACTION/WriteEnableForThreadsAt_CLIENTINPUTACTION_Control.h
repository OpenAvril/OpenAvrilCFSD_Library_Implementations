...
{
    class WriteEnableForThreadsAt_CLIENTINPUTACTION_Control
    {
    public:
// constructor.
        WriteEnableForThreadsAt_CLIENTINPUTACTION_Control(class WriteEnableForThreadsAt_CLIENTINPUTACTION_Global* global);

// destructor.
        ~WriteEnableForThreadsAt_CLIENTINPUTACTION_Control();
...
// public.
    // dynamin.  
        ...
        void writeEnable_Activate(class WriteEnableForThreadsAt_CLIENTINPUTACTION_Framework* obj, uint8_t coreId);
        void writeEnable_SortQue(class WriteEnableForThreadsAt_CLIENTINPUTACTION_Framework* obj);
        void writeEnable_Request(class WriteEnableForThreadsAt_CLIENTINPUTACTION_Framework* obj, uint8_t coreId);
        void writeQue_Update(class WriteEnableForThreadsAt_CLIENTINPUTACTION_Framework* obj);
        // get.
...
// private.
    // dynamin.
        void dynamicStagger(class WriteEnableForThreadsAt_CLIENTINPUTACTION_Framework* obj, uint8_t coreId);
        void writeEnable_ShiftQueValues(class WriteEnableForThreadsAt_CLIENTINPUTACTION_Framework* obj, uint8_t coreId_A, uint8_t coreId_B);
        // get.
        // set.
    // static.
