#include "pch.h"
bool* OpenAvrilCLIBWriteEnableForThreadsAtCLIENTINPUTACTION::WriteEnableForThreadsAt_CLIENTINPUTACTION_Control::_stat_REG_ptr_flag_praisingWrite;
std::array<std::array<bool, 2>, 3>* OpenAvrilCLIBWriteEnableForThreadsAtCLIENTINPUTACTION::WriteEnableForThreadsAt_CLIENTINPUTACTION_Control::_stat_REG_LIST_Of_3STATE_flag_WriteState;
std::list<uint32_t>* OpenAvrilCLIBWriteEnableForThreadsAtCLIENTINPUTACTION::WriteEnableForThreadsAt_CLIENTINPUTACTION_Control::_stat_REG_LIST_Of_WriteACTIVE_Count_For_ThreadId;
std::list<uint32_t>* OpenAvrilCLIBWriteEnableForThreadsAtCLIENTINPUTACTION::WriteEnableForThreadsAt_CLIENTINPUTACTION_Control::_stat_REG_LIST_Of_WriteIDLE_Count_For_ThreadId;
std::list<uint32_t>* OpenAvrilCLIBWriteEnableForThreadsAtCLIENTINPUTACTION::WriteEnableForThreadsAt_CLIENTINPUTACTION_Control::_stat_REG_LIST_Of_WriteWAIT_Count_For_ThreadId;
uint8_t* OpenAvrilCLIBWriteEnableForThreadsAtCLIENTINPUTACTION::WriteEnableForThreadsAt_CLIENTINPUTACTION_Control::_stat_REG_ptr_new_writeCycle_Try_ThreadId_Index;
std::list<uint8_t>* OpenAvrilCLIBWriteEnableForThreadsAtCLIENTINPUTACTION::WriteEnableForThreadsAt_CLIENTINPUTACTION_Control::_stat_REG_QUE_Of_ThreadID_To_WRITE;
uint8_t* OpenAvrilCLIBWriteEnableForThreadsAtCLIENTINPUTACTION::WriteEnableForThreadsAt_CLIENTINPUTACTION_Control::_stat_REG_ptr_writeCycle_Try_ThreadId_Index;
    ...
    {
        boot0_CLASS_DECLAIRE_WriteEnableForThreadsAt_CLIENTINPUTACTION_Control();
        boot1_CLASS_DEFINE_WriteEnableForThreadsAt_CLIENTINPUTACTION_Control();
        boot3_CLASS_INITIALISE_WriteEnableForThreadsAt_CLIENTINPUTACTION_Control();
        boot0_REG_DECLAIRE_WriteEnableForThreadsAt_CLIENTINPUTACTION_Control();
    }
    OpenAvrilCLIBWriteEnableForThreadsAtCLIENTINPUTACTION::WriteEnableForThreadsAt_CLIENTINPUTACTION_Control::~WriteEnableForThreadsAt_CLIENTINPUTACTION_Control()
    {
    ...
    void OpenAvrilCLIBWriteEnableForThreadsAtCLIENTINPUTACTION::WriteEnableForThreadsAt_CLIENTINPUTACTION_Control::boot0_CLASS_DECLAIRE_WriteEnableForThreadsAt_CLIENTINPUTACTION_Control()
    {
        std::cout << "entered boot0_CLASS_DECLAIRE_WriteEnableForThreadsAt_CLIENTINPUTACTION_Control()" << std::endl;

        std::cout << "exiting boot0_CLASS_DECLAIRE_WriteEnableForThreadsAt_CLIENTINPUTACTION_Control()" << std::endl;
    }
    void OpenAvrilCLIBWriteEnableForThreadsAtCLIENTINPUTACTION::WriteEnableForThreadsAt_CLIENTINPUTACTION_Control::boot1_CLASS_DEFINE_WriteEnableForThreadsAt_CLIENTINPUTACTION_Control()
    {
        std::cout << "entered boot1_CLASS_DEFINE_WriteEnableForThreadsAt_CLIENTINPUTACTION_Control" << std::endl;

        std::cout << "exiting boot1_CLASS_DEFINE_WriteEnableForThreadsAt_CLIENTINPUTACTION_Control" << std::endl;
    }
    void OpenAvrilCLIBWriteEnableForThreadsAtCLIENTINPUTACTION::WriteEnableForThreadsAt_CLIENTINPUTACTION_Control::boot3_CLASS_INITIALISE_WriteEnableForThreadsAt_CLIENTINPUTACTION_Control()
    {
        std::cout << "entered boot3_CLASS_INITIALISE_WriteEnableForThreadsAt_CLIENTINPUTACTION_Control()" << std::endl;

        std::cout << "exiting boot3_CLASS_INITIALISE_WriteEnableForThreadsAt_CLIENTINPUTACTION_Control()" << std::endl;
    }
    void OpenAvrilCLIBWriteEnableForThreadsAtCLIENTINPUTACTION::WriteEnableForThreadsAt_CLIENTINPUTACTION_Control::boot0_REG_DECLAIRE_WriteEnableForThreadsAt_CLIENTINPUTACTION_Control()
    {
        std::cout << "entered boot0_REG_DECLAIRE_WriteEnableForThreadsAt_CLIENTINPUTACTION_Control()" << std::endl;

        std::cout << "exiting boot0_REG_DECLAIRE_WriteEnableForThreadsAt_CLIENTINPUTACTION_Control()" << std::endl;
    }
    void OpenAvrilCLIBWriteEnableForThreadsAtCLIENTINPUTACTION::WriteEnableForThreadsAt_CLIENTINPUTACTION_Control::boot1_REG_DEFINE_WriteEnableForThreadsAt_CLIENTINPUTACTION_Control(OpenAvrilCLIBWriteEnableForThreadsAtCLIENTINPUTACTION::WriteEnableForThreadsAt_CLIENTINPUTACTION_Framework* obj)
    {
        std::cout << "entered boot1_REG_DEFINE_WriteEnableForThreadsAt_CLIENTINPUTACTION_Control()" << std::endl;
        ...
        std::cout << "exiting boot1_REG_DEFINE_WriteEnableForThreadsAt_CLIENTINPUTACTION_Control()" << std::endl;
    }
    void OpenAvrilCLIBWriteEnableForThreadsAtCLIENTINPUTACTION::WriteEnableForThreadsAt_CLIENTINPUTACTION_Control::boot2_REG_SUBSTANTIATE_WriteEnableForThreadsAt_CLIENTINPUTACTION_Control(OpenAvrilCLIBWriteEnableForThreadsAtCLIENTINPUTACTION::WriteEnableForThreadsAt_CLIENTINPUTACTION_Framework* obj)
    {
        std::cout << "entered boot2_REG_SUBSTANTIATE_WriteEnableForThreadsAt_CLIENTINPUTACTION_Control()" << std::endl;
        ...
        std::cout << "exiting boot2_REG_SUBSTANTIATE_WriteEnableForThreadsAt_CLIENTINPUTACTION_Control()" << std::endl;
    }
    void OpenAvrilCLIBWriteEnableForThreadsAtCLIENTINPUTACTION::WriteEnableForThreadsAt_CLIENTINPUTACTION_Control::boot3_REG_INITIALISE_WriteEnableForThreadsAt_CLIENTINPUTACTION_Control(OpenAvrilCLIBWriteEnableForThreadsAtCLIENTINPUTACTION::WriteEnableForThreadsAt_CLIENTINPUTACTION_Framework* obj)
    {
        std::cout << "entered boot3_REG_INITIALISE_WriteEnableForThreadsAt_CLIENTINPUTACTION_Control()" << std::endl;
        ...
        std::cout << "exiting boot3_REG_INITIALISE_WriteEnableForThreadsAt_CLIENTINPUTACTION_Control()" << std::endl;
    }
    void OpenAvrilCLIBWriteEnableForThreadsAtCLIENTINPUTACTION::WriteEnableForThreadsAt_CLIENTINPUTACTION_Control::boot4_PGM_INSTANTIATE_WriteEnableForThreadsAt_CLIENTINPUTACTION_Control(OpenAvrilCLIBWriteEnableForThreadsAtCLIENTINPUTACTION::WriteEnableForThreadsAt_CLIENTINPUTACTION_Framework* obj)
    {
        //if thread primed and system initialised, exit, else wait.
    }
    void OpenAvrilCLIBWriteEnableForThreadsAtCLIENTINPUTACTION::WriteEnableForThreadsAt_CLIENTINPUTACTION_Control::app_FUNCT_writeEnable_Activate(OpenAvrilCLIBWriteEnableForThreadsAtCLIENTINPUTACTION::WriteEnableForThreadsAt_CLIENTINPUTACTION_Framework* obj, uint8_t coreId)
    {
    ...
    void OpenAvrilCLIBWriteEnableForThreadsAtCLIENTINPUTACTION::WriteEnableForThreadsAt_CLIENTINPUTACTION_Control::app_FUNCT_writeEnable_SortQue(OpenAvrilCLIBWriteEnableForThreadsAtCLIENTINPUTACTION::WriteEnableForThreadsAt_CLIENTINPUTACTION_Framework* obj)
    {
    ...
    void OpenAvrilCLIBWriteEnableForThreadsAtCLIENTINPUTACTION::WriteEnableForThreadsAt_CLIENTINPUTACTION_Control::app_FUNCT_writeEnable_Request(OpenAvrilCLIBWriteEnableForThreadsAtCLIENTINPUTACTION::WriteEnableForThreadsAt_CLIENTINPUTACTION_Framework* obj, uint8_t coreId)
    {
    ...
    void OpenAvrilCLIBWriteEnableForThreadsAtCLIENTINPUTACTION::WriteEnableForThreadsAt_CLIENTINPUTACTION_Control::app_FUNCT_writeQue_Update(OpenAvrilCLIBWriteEnableForThreadsAtCLIENTINPUTACTION::WriteEnableForThreadsAt_CLIENTINPUTACTION_Framework* obj)
    {
    ...
    uint32_t OpenAvrilCLIBWriteEnableForThreadsAtCLIENTINPUTACTION::WriteEnableForThreadsAt_CLIENTINPUTACTION_Control::dyn_REG_get_Item_On_list_Of_WriteActive_Count_For_ThreadId(uint8_t concurrentThreadID)
    {
        auto temp = stat_REG_get_ptr_list_Of_WriteActive_Count_For_ThreadId()->begin();
        std::advance(temp, concurrentThreadID);
        return *temp;
    }
    uint32_t OpenAvrilCLIBWriteEnableForThreadsAtCLIENTINPUTACTION::WriteEnableForThreadsAt_CLIENTINPUTACTION_Control::dyn_REG_get_Item_On_list_Of_WriteIdle_Count_For_ThreadId(uint8_t concurrentThreadID)
    {
        auto temp = stat_REG_get_ptr_list_Of_WriteIdle_Count_For_ThreadId()->begin();
        std::advance(temp, concurrentThreadID);
        return *temp;
    }
    uint32_t OpenAvrilCLIBWriteEnableForThreadsAtCLIENTINPUTACTION::WriteEnableForThreadsAt_CLIENTINPUTACTION_Control::dyn_REG_get_Item_On_list_Of_WriteWait_Count_For_ThreadId(uint8_t concurrentThreadID)
    {
        auto temp = stat_REG_get_ptr_list_Of_WriteWait_Count_For_ThreadId()->begin();
        std::advance(temp, concurrentThreadID);
        return *temp;
    }
    uint8_t OpenAvrilCLIBWriteEnableForThreadsAtCLIENTINPUTACTION::WriteEnableForThreadsAt_CLIENTINPUTACTION_Control::dyn_REG_get_Item_new_writeCycle_Try_ThreadId_Index()
    {
        return *stat_REG_get_ptr_new_writeCycle_Try_ThreadId_Index();
    }
    uint8_t OpenAvrilCLIBWriteEnableForThreadsAtCLIENTINPUTACTION::WriteEnableForThreadsAt_CLIENTINPUTACTION_Control::dyn_REG_get_Item_On_QUE_List_Of_ThreadToWrite(uint8_t slotID)
    {
        auto temp = stat_REG_get_ptr_QUE_List_Of_ThreadToWrite()->begin();
        std::advance(temp, slotID);
        return *temp;
    }
    uint8_t OpenAvrilCLIBWriteEnableForThreadsAtCLIENTINPUTACTION::WriteEnableForThreadsAt_CLIENTINPUTACTION_Control::dyn_REG_get_Item_writeCycle_Try_ThreadId_Index()
    {
    ...
    void OpenAvrilCLIBWriteEnableForThreadsAtCLIENTINPUTACTION::WriteEnableForThreadsAt_CLIENTINPUTACTION_Control::stat_REG_boot1_DEFINE_ptr_flag_praisingWrite()
    {
        _stat_REG_ptr_flag_praisingWrite = NULL;
    }
    void OpenAvrilCLIBWriteEnableForThreadsAtCLIENTINPUTACTION::WriteEnableForThreadsAt_CLIENTINPUTACTION_Control::stat_REG_boot1_DEFINE_ptr_3STATE_flag_WriteState()
    {
        _stat_REG_LIST_Of_3STATE_flag_WriteState = NULL;
    }
    void OpenAvrilCLIBWriteEnableForThreadsAtCLIENTINPUTACTION::WriteEnableForThreadsAt_CLIENTINPUTACTION_Control::stat_REG_boot1_DEFINE_ptr_WriteACTIVE_Count_For_ThreadId()
    {
        _stat_REG_LIST_Of_WriteACTIVE_Count_For_ThreadId = NULL;
    }
    void OpenAvrilCLIBWriteEnableForThreadsAtCLIENTINPUTACTION::WriteEnableForThreadsAt_CLIENTINPUTACTION_Control::stat_REG_boot1_DEFINE_ptr_WriteIDLE_Count_For_ThreadId()
    {
        _stat_REG_LIST_Of_WriteIDLE_Count_For_ThreadId = NULL;
    }
    void OpenAvrilCLIBWriteEnableForThreadsAtCLIENTINPUTACTION::WriteEnableForThreadsAt_CLIENTINPUTACTION_Control::stat_REG_boot1_DEFINE_ptr_WriteWAIT_Count_For_ThreadId()
    {
        _stat_REG_LIST_Of_WriteWAIT_Count_For_ThreadId = NULL;
    }
    void OpenAvrilCLIBWriteEnableForThreadsAtCLIENTINPUTACTION::WriteEnableForThreadsAt_CLIENTINPUTACTION_Control::stat_REG_boot1_DEFINE_ptr_new_writeCycle_Try_ThreadId_Index()
    {
        _stat_REG_ptr_new_writeCycle_Try_ThreadId_Index = NULL;
    }
    void OpenAvrilCLIBWriteEnableForThreadsAtCLIENTINPUTACTION::WriteEnableForThreadsAt_CLIENTINPUTACTION_Control::stat_REG_boot1_DEFINE_ptr_QUE_Of_ThreadID_To_WRITE()
    {
        _stat_REG_QUE_Of_ThreadID_To_WRITE = NULL;
    }
    void OpenAvrilCLIBWriteEnableForThreadsAtCLIENTINPUTACTION::WriteEnableForThreadsAt_CLIENTINPUTACTION_Control::stat_REG_boot1_DEFINE_ptr_writeCycle_Try_ThreadId_Index()
    {
        _stat_REG_ptr_writeCycle_Try_ThreadId_Index = NULL;
    }
    void OpenAvrilCLIBWriteEnableForThreadsAtCLIENTINPUTACTION::WriteEnableForThreadsAt_CLIENTINPUTACTION_Control::stat_REG_boot2_SUBSTANTIATE_ptr_flag_praisingWrite()
    {
        _stat_REG_ptr_flag_praisingWrite = new bool();
        *_stat_REG_ptr_flag_praisingWrite = true;
    }
    void OpenAvrilCLIBWriteEnableForThreadsAtCLIENTINPUTACTION::WriteEnableForThreadsAt_CLIENTINPUTACTION_Control::stat_REG_boot2_SUBSTANTIATE_ptrv_3STATE_flag_WriteState()
    {
    ...
    void OpenAvrilCLIBWriteEnableForThreadsAtCLIENTINPUTACTION::WriteEnableForThreadsAt_CLIENTINPUTACTION_Control::stat_REG_boot2_SUBSTANTIATE_WriteACTIVE_Count_For_ThreadId(OpenAvrilCLIBWriteEnableForThreadsAtCLIENTINPUTACTION::WriteEnableForThreadsAt_CLIENTINPUTACTION_Framework* obj)
    {
    ...
    void OpenAvrilCLIBWriteEnableForThreadsAtCLIENTINPUTACTION::WriteEnableForThreadsAt_CLIENTINPUTACTION_Control::stat_REG_boot2_SUBSTANTIATE_WriteIDLE_Count_For_ThreadId(OpenAvrilCLIBWriteEnableForThreadsAtCLIENTINPUTACTION::WriteEnableForThreadsAt_CLIENTINPUTACTION_Framework* obj)
    {
    ...
    void OpenAvrilCLIBWriteEnableForThreadsAtCLIENTINPUTACTION::WriteEnableForThreadsAt_CLIENTINPUTACTION_Control::stat_REG_boot2_SUBSTANTIATE_WriteWAIT_Count_For_ThreadId(OpenAvrilCLIBWriteEnableForThreadsAtCLIENTINPUTACTION::WriteEnableForThreadsAt_CLIENTINPUTACTION_Framework* obj)
    {
    ...
    void OpenAvrilCLIBWriteEnableForThreadsAtCLIENTINPUTACTION::WriteEnableForThreadsAt_CLIENTINPUTACTION_Control::stat_REG_boot2_SUBSTANTIATE_new_writeCycle_Try_ThreadId_Index()
    {
    ...
    void OpenAvrilCLIBWriteEnableForThreadsAtCLIENTINPUTACTION::WriteEnableForThreadsAt_CLIENTINPUTACTION_Control::stat_REG_boot2_SUBSTANTIATE_ptr_QUE_Of_ThreadID_To_WRITE()
    {
    ...
    void OpenAvrilCLIBWriteEnableForThreadsAtCLIENTINPUTACTION::WriteEnableForThreadsAt_CLIENTINPUTACTION_Control::stat_REG_boot2_SUBSTANTIATE_writeCycle_Try_ThreadId_Index()
    {
        _stat_REG_ptr_writeCycle_Try_ThreadId_Index = new uint8_t();
        *_stat_REG_ptr_writeCycle_Try_ThreadId_Index = uint8_t(UINT8_MAX);
    }
    void OpenAvrilCLIBWriteEnableForThreadsAtCLIENTINPUTACTION::WriteEnableForThreadsAt_CLIENTINPUTACTION_Control::stat_REG_boot3_INITIALISE_ptr_flag_praisingWrite()
    {
        _stat_REG_ptr_flag_praisingWrite = new bool();
        *_stat_REG_ptr_flag_praisingWrite = false;
    }
    void OpenAvrilCLIBWriteEnableForThreadsAtCLIENTINPUTACTION::WriteEnableForThreadsAt_CLIENTINPUTACTION_Control::stat_REG_boot3_INITIALISE_ptr_3STATE_flag_WriteState()
    {
        _stat_REG_LIST_Of_3STATE_flag_WriteState = new std::array <std::array<bool, 2>, 3>();
        while (stat_REG_get_ptr_Array_Of_3STATE_flag_WriteState() == NULL) {}
    ...
    void OpenAvrilCLIBWriteEnableForThreadsAtCLIENTINPUTACTION::WriteEnableForThreadsAt_CLIENTINPUTACTION_Control::stat_REG_boot3_INITIALISE_ptr_WriteACTIVE_Count_For_ThreadId()
    {
        *_stat_REG_LIST_Of_WriteACTIVE_Count_For_ThreadId = { (uint32_t)(0), (uint32_t)(0), (uint32_t)(0), (uint32_t)(0) };
    }
    void OpenAvrilCLIBWriteEnableForThreadsAtCLIENTINPUTACTION::WriteEnableForThreadsAt_CLIENTINPUTACTION_Control::stat_REG_boot3_INITIALISE_WriteIDLE_Count_For_ThreadId()
    {
        *_stat_REG_LIST_Of_WriteIDLE_Count_For_ThreadId = { (uint32_t)(0), (uint32_t)(0), (uint32_t)(0), (uint32_t)(0) };
    }
    void OpenAvrilCLIBWriteEnableForThreadsAtCLIENTINPUTACTION::WriteEnableForThreadsAt_CLIENTINPUTACTION_Control::stat_REG_boot3_INITIALISE_WriteWAIT_Count_For_ThreadIdd()
    {
        *_stat_REG_LIST_Of_WriteWAIT_Count_For_ThreadId = { (uint32_t)(0), (uint32_t)(0), (uint32_t)(0), (uint32_t)(0) };
    }
    void OpenAvrilCLIBWriteEnableForThreadsAtCLIENTINPUTACTION::WriteEnableForThreadsAt_CLIENTINPUTACTION_Control::stat_REG_boot3_INITIALISE_new_writeCycle_Try_ThreadId_Index()
    {
        *_stat_REG_ptr_new_writeCycle_Try_ThreadId_Index = (uint8_t)(1);
    }
    void OpenAvrilCLIBWriteEnableForThreadsAtCLIENTINPUTACTION::WriteEnableForThreadsAt_CLIENTINPUTACTION_Control::stat_REG_boot3_INITIALISE_ptr_QUE_Of_ThreadID_To_WRITE()
    {
        *_stat_REG_QUE_Of_ThreadID_To_WRITE = { (uint8_t)(0), (uint8_t)(1), (uint8_t)(2), (uint8_t)(3) };
    }
    void OpenAvrilCLIBWriteEnableForThreadsAtCLIENTINPUTACTION::WriteEnableForThreadsAt_CLIENTINPUTACTION_Control::stat_REG_boot3_INITIALISE_writeCycle_Try_ThreadId_Index()
    {
    ...
    std::array<std::array<bool, 2>, 3>* OpenAvrilCLIBWriteEnableForThreadsAtCLIENTINPUTACTION::WriteEnableForThreadsAt_CLIENTINPUTACTION_Control::stat_REG_get_ptr_Array_Of_3STATE_flag_WriteState()
    {
    ...
    void OpenAvrilCLIBWriteEnableForThreadsAtCLIENTINPUTACTION::WriteEnableForThreadsAt_CLIENTINPUTACTION_Control::stat_REG_set_Item_On_list_Of_WriteIdle_Count_For_ThreadId(uint8_t concurrentThreadID, uint32_t newCount)
    {
        auto temp = stat_REG_get_ptr_list_Of_WriteIdle_Count_For_ThreadId()->begin();
        std::advance(temp, concurrentThreadID);
        *temp = newCount;
