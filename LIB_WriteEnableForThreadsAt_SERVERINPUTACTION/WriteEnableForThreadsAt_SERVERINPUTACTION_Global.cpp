...
// public.
    ...
    std::array<bool, 2> OpenAvrilCLIDWriteEnableForThreadsAtSERVERINPUTACTION::WriteEnableForThreadsAt_SERVERINPUTACTION_Global::dyn_REG_get_3STATE_flag_WAIT()
    {
        return *stat_REG_get_ptr_3STATE_flag_WAIT();
    }
    std::array<bool, 2> OpenAvrilCLIDWriteEnableForThreadsAtSERVERINPUTACTION::WriteEnableForThreadsAt_SERVERINPUTACTION_Global::dyn_REG_get_3STATE_flag_WRITE()
    {
        return *stat_REG_get_ptr_3STATE_flag_WRITE();
    }
    uint8_t OpenAvrilCLIDWriteEnableForThreadsAtSERVERINPUTACTION::WriteEnableForThreadsAt_SERVERINPUTACTION_Global::dyn_REG_get_number_Of_Implemented_Threads()
    {
...
// private.
    ...
    void OpenAvrilCLIDWriteEnableForThreadsAtSERVERINPUTACTION::WriteEnableForThreadsAt_SERVERINPUTACTION_Global::stat_REG_create_3STATE_flag_WAIT(std::array<bool, 2>* newDEAFULT_FlagSet)
    {
    ...
    void OpenAvrilCLIDWriteEnableForThreadsAtSERVERINPUTACTION::WriteEnableForThreadsAt_SERVERINPUTACTION_Global::stat_REG_create_3STATE_flag_WRITE(std::array<bool, 2>* newDEAFULT_FlagSet)
    {
    ...
    void OpenAvrilCLIDWriteEnableForThreadsAtSERVERINPUTACTION::WriteEnableForThreadsAt_SERVERINPUTACTION_Global::stat_REG_create_number_Of_Implemented_Threads(uint8_t* newDEFAULT_Value)
    {
    ...
    std::array<bool, 2>* OpenAvrilCLIDWriteEnableForThreadsAtSERVERINPUTACTION::WriteEnableForThreadsAt_SERVERINPUTACTION_Global::stat_REG_get_ptr_3STATE_flag_WAIT()
    {
        return _REG_ptr_3STATE_flag_WAIT;
    }
    std::array<bool, 2>* OpenAvrilCLIDWriteEnableForThreadsAtSERVERINPUTACTION::WriteEnableForThreadsAt_SERVERINPUTACTION_Global::stat_REG_get_ptr_3STATE_flag_WRITE()
    {
        return _REG_ptr_3STATE_flag_WRITE;
    }
    uint8_t* OpenAvrilCLIDWriteEnableForThreadsAtSERVERINPUTACTION::WriteEnableForThreadsAt_SERVERINPUTACTION_Global::stat_REG_get_ptr_number_Of_Implemented_Threads()
    {
    ...
    void OpenAvrilCLIDWriteEnableForThreadsAtSERVERINPUTACTION::WriteEnableForThreadsAt_SERVERINPUTACTION_Global::stat_REG_set_3STATE_flag_WAIT(std::array<bool, 2> new_FlagBitSet)
    {
        *_REG_ptr_3STATE_flag_WAIT = new_FlagBitSet;
    }
    void OpenAvrilCLIDWriteEnableForThreadsAtSERVERINPUTACTION::WriteEnableForThreadsAt_SERVERINPUTACTION_Global::stat_REG_set_3STATE_flag_WRITE(std::array<bool, 2> new_FlagBitSet)
    {
        *_REG_ptr_3STATE_flag_WRITE = new_FlagBitSet;
    }
    void OpenAvrilCLIDWriteEnableForThreadsAtSERVERINPUTACTION::WriteEnableForThreadsAt_SERVERINPUTACTION_Global::stat_REG_set_number_Of_Implemented_Threads(uint8_t newValue)
    {
