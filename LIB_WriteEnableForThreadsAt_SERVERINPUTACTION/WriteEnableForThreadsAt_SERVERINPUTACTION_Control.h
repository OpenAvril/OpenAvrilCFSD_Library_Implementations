...
{
    class WriteEnableForThreadsAt_SERVERINPUTACTION_Control
    {
    public:
        WriteEnableForThreadsAt_SERVERINPUTACTION_Control();
        ~WriteEnableForThreadsAt_SERVERINPUTACTION_Control();
        void app_writeEnable_Activate(class WriteEnableForThreadsAt_SERVERINPUTACTION_Framework* obj, uint8_t coreId);
        void app_writeEnable_SortQue(class WriteEnableForThreadsAt_SERVERINPUTACTION_Framework* obj);
        void app_writeEnable_Request(class WriteEnableForThreadsAt_SERVERINPUTACTION_Framework* obj, uint8_t coreId);
        void app_writeQue_Update(class WriteEnableForThreadsAt_SERVERINPUTACTION_Framework* obj);
        ...
        void dynamicStagger(class WriteEnableForThreadsAt_SERVERINPUTACTION_Framework* obj, uint8_t coreId);
        void writeEnable_ShiftQueValues(class WriteEnableForThreadsAt_SERVERINPUTACTION_Framework* obj, uint8_t coreId_A, uint8_t coreId_B);
