...
namespace OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtSERVER
{
    ...
    public:
        ...
        void dyn_REG_initialise_Item_On_list_Of_STATE_For_ConcurrentCore(uint8_t concurrenct_threadID, class LaunchEnableForConcurrentThreadsAt_SERVER_Global* ptr_Global);
