...
// pointers.
    // classes.
    // registers.
    uint8_t* OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtSERVER::LaunchEnableForConcurrentThreadsAt_SERVER_Control::_ptr_concurrentCycle_Try_CoreId_Index = NULL;
    bool* OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtSERVER::LaunchEnableForConcurrentThreadsAt_SERVER_Control::_ptr_flag_praisinglaunch = NULL;
    std::list<uint32_t>* OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtSERVER::LaunchEnableForConcurrentThreadsAt_SERVER_Control::_ptr_list_Of_launchActive_Count_For_ThreadID = NULL;
    std::list<uint32_t>* OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtSERVER::LaunchEnableForConcurrentThreadsAt_SERVER_Control::_ptr_list_Of_launchIdle_Count_For_ThreadID = NULL;
    std::list<bool>* OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtSERVER::LaunchEnableForConcurrentThreadsAt_SERVER_Control::_ptr_list_Of_STATE_For_ConcurrentCore = NULL;
    std::list<uint8_t>* OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtSERVER::LaunchEnableForConcurrentThreadsAt_SERVER_Control::_ptr_list_for_Que_Of_CoreTolaunch = NULL;
    uint8_t* OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtSERVER::LaunchEnableForConcurrentThreadsAt_SERVER_Control::_ptr_new_concurrentCycle_Try_CoreId_Index = NULL;
...
// public.
    // dynamic.
    void OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtSERVER::LaunchEnableForConcurrentThreadsAt_SERVER_Control::initialise_concurrentCycle_Try_CoreId_Index(uint8_t* newINITIALISED_Value)
    {
        stat_set_concurrentCycle_Try_CoreId_Index(*newINITIALISED_Value);
    }
    void OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtSERVER::LaunchEnableForConcurrentThreadsAt_SERVER_Control::initialise_flag_praisinglaunch(bool* newINITIALISED_Flagbit)
    {
        stat_set_flag_praisinglaunch(*newINITIALISED_Flagbit);
    }
    void OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtSERVER::LaunchEnableForConcurrentThreadsAt_SERVER_Control::initialise_Item_On_list_Of_launchActive_Count_For_ThreadID(uint8_t concurrenctThreadID, uint32_t* newINITIALISED_Value)
    {
    ...
    void OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtSERVER::LaunchEnableForConcurrentThreadsAt_SERVER_Control::initialise_Item_On_list_Of_launchIdle_Count_For_ThreadID(uint8_t concurrenctThreadID, uint32_t* newINITIALISED_Value)
    {
        auto temp = stat_get_ptr_list_Of_launchIdle_Count_For_ThreadID()->begin();
        std::advance(temp, concurrenctThreadID);
        *temp = *newINITIALISED_Value;
    }
    void OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtSERVER::LaunchEnableForConcurrentThreadsAt_SERVER_Control::initialise_Item_On_list_Of_STATE_For_ConcurrentCore(uint8_t concurrenct_threadID, LaunchEnableForConcurrentThreadsAt_SERVER_Global* ptr_Global)
    {
        stat_set_Item_On_list_Of_STATE_For_ConcurrentCore(concurrenct_threadID, ptr_Global->get_flag_core_IDLE());
    }
    void OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtSERVER::LaunchEnableForConcurrentThreadsAt_SERVER_Control::initialise_new_concurrentCycle_Try_CoreId_Index(uint8_t* _new_concurrentCycle_Try_CoreId_Index)
    {
        stat_set_new_concurrentCycle_Try_CoreId_Index(*_new_concurrentCycle_Try_CoreId_Index);
    }
    void OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtSERVER::LaunchEnableForConcurrentThreadsAt_SERVER_Control::initialise_Item_On_list_Of_Que_Of_CoreTolaunch(uint8_t slotID)
    {
    ...
    void OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtSERVER::LaunchEnableForConcurrentThreadsAt_SERVER_Control::launchQue_Update(OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtSERVER::LaunchEnableForConcurrentThreadsAt_SERVER_Framework* obj, uint8_t number_Implemented_Threads)
    {
        ...
        // get.
    uint8_t OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtSERVER::LaunchEnableForConcurrentThreadsAt_SERVER_Control::get_concurrentCycle_Try_CoreId_Index()
    {
        return *stat_ptr_get_concurrentCycle_Try_CoreId_Index();
    }
    bool OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtSERVER::LaunchEnableForConcurrentThreadsAt_SERVER_Control::get_flag_praisinglaunch()
    {
        return *stat_ptr_get_flag_praisinglaunch();
    }
    uint32_t OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtSERVER::LaunchEnableForConcurrentThreadsAt_SERVER_Control::get_Item_On_list_Of_launchActive_Count_For_ThreadID(uint8_t threadID)
    {
        auto temp = stat_get_ptr_list_Of_launchActive_Count_For_ThreadID()->begin();
        std::advance(temp, threadID);
        return *temp;
    }
    uint32_t OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtSERVER::LaunchEnableForConcurrentThreadsAt_SERVER_Control::get_Item_On_list_Of_launchIdle_Count_For_ThreadID(uint8_t threadID)
    {
        auto temp = stat_get_ptr_list_Of_launchIdle_Count_For_ThreadID()->begin();
        std::advance(temp, threadID);
        return *temp;
    }
    bool OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtSERVER::LaunchEnableForConcurrentThreadsAt_SERVER_Control::get_Item_On_list_Of_STATE_For_ConcurrentCore(uint8_t concurrenct_threadID)
    {
        auto temp = stat_get_ptr_list_Of_STATE_For_ConcurrentCore()->begin();
        std::advance(temp, concurrenct_threadID);
        return *temp;
    }
    uint8_t OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtSERVER::LaunchEnableForConcurrentThreadsAt_SERVER_Control::get_Item_On_list_for_Que_Of_CoreTolaunch(uint8_t concurrenct_threadID)
    {
        auto temp = stat_get_ptr_list_Of_Que_Of_CoreTolaunch()->begin();
        std::advance(temp, concurrenct_threadID);
        return *temp;
    }
    uint8_t OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtSERVER::LaunchEnableForConcurrentThreadsAt_SERVER_Control::get_new_concurrentCycle_Try_CoreId_Index()
    {
...
// private.
    ...
    void OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtSERVER::LaunchEnableForConcurrentThreadsAt_SERVER_Control::launchEnable_ShiftQueValues(OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtSERVER::LaunchEnableForConcurrentThreadsAt_SERVER_Framework* obj, uint8_t concurrentThreadID_A, uint8_t concurrentThreadID_B)
    {
        ...
        // set.
    // static.
    void OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtSERVER::LaunchEnableForConcurrentThreadsAt_SERVER_Control::create_concurrentCycle_Try_CoreId_Index(uint8_t* newDEFAULT_Value)
    {
    ...
    void OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtSERVER::LaunchEnableForConcurrentThreadsAt_SERVER_Control::create_flag_praisinglaunch(bool* newDEFAULT_Flagbit)
    {
    ...
    void OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtSERVER::LaunchEnableForConcurrentThreadsAt_SERVER_Control::create_list_Of_launchActive_Count_For_ThreadID(uint32_t* newDEFAULT_Value)
    {
    ...
    void OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtSERVER::LaunchEnableForConcurrentThreadsAt_SERVER_Control::create_list_Of_launchIdle_Count_For_ThreadID(uint32_t* newDEFAULT_Value)
    {
    ...
    void OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtSERVER::LaunchEnableForConcurrentThreadsAt_SERVER_Control::create_list_Of_STATE_For_ConcurrentCore(bool* newDEFAULT_FlagBit)
    {
    ...
    void OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtSERVER::LaunchEnableForConcurrentThreadsAt_SERVER_Control::create_list_for_Que_Of_CoreTolaunch()
    {
    ...
    void OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtSERVER::LaunchEnableForConcurrentThreadsAt_SERVER_Control::create_new_concurrentCycle_Try_CoreId_Index(uint8_t* newDEFAULT_Value)
    {
        ...
        // get.
    uint8_t* OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtSERVER::LaunchEnableForConcurrentThreadsAt_SERVER_Control::stat_ptr_get_concurrentCycle_Try_CoreId_Index()
    {
        return _ptr_concurrentCycle_Try_CoreId_Index;
    }
    bool* OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtSERVER::LaunchEnableForConcurrentThreadsAt_SERVER_Control::stat_ptr_get_flag_praisinglaunch()
    {
        return _ptr_flag_praisinglaunch;
    }
    std::list<uint32_t>* OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtSERVER::LaunchEnableForConcurrentThreadsAt_SERVER_Control::stat_get_ptr_list_Of_launchActive_Count_For_ThreadID()
    {
        return _ptr_list_Of_launchActive_Count_For_ThreadID;
    }
    std::list<uint32_t>* OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtSERVER::LaunchEnableForConcurrentThreadsAt_SERVER_Control::stat_get_ptr_list_Of_launchIdle_Count_For_ThreadID()
    {
        return _ptr_list_Of_launchIdle_Count_For_ThreadID;
    }
    std::list<bool>* OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtSERVER::LaunchEnableForConcurrentThreadsAt_SERVER_Control::stat_get_ptr_list_Of_STATE_For_ConcurrentCore()
    {
        return _ptr_list_Of_STATE_For_ConcurrentCore;
    }
    std::list<uint8_t>* OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtSERVER::LaunchEnableForConcurrentThreadsAt_SERVER_Control::stat_get_ptr_list_Of_Que_Of_CoreTolaunch()
    {
        return _ptr_list_for_Que_Of_CoreTolaunch;
    }
    uint8_t* OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtSERVER::LaunchEnableForConcurrentThreadsAt_SERVER_Control::stat_get_ptr_new_concurrentCycle_Try_CoreId_Index()
    {
        return _ptr_new_concurrentCycle_Try_CoreId_Index;
    }
        // set.
    void OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtSERVER::LaunchEnableForConcurrentThreadsAt_SERVER_Control::stat_set_concurrentCycle_Try_CoreId_Index(uint8_t newValue)
    {
        *_ptr_concurrentCycle_Try_CoreId_Index = newValue;
    }
    void OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtSERVER::LaunchEnableForConcurrentThreadsAt_SERVER_Control::stat_set_flag_praisinglaunch(bool newFlag)
    {
        *_ptr_flag_praisinglaunch = newFlag;
    }
    void OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtSERVER::LaunchEnableForConcurrentThreadsAt_SERVER_Control::stat_set_Item_On_list_Of_launchActive_Count_For_ThreadID(uint8_t concurrenctThreadID, uint32_t newValue)
    {
        auto temp = stat_get_ptr_list_Of_launchActive_Count_For_ThreadID()->begin();
        std::advance(temp, concurrenctThreadID);
        *temp = newValue;
    }
    void OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtSERVER::LaunchEnableForConcurrentThreadsAt_SERVER_Control::stat_set_Item_On_list_Of_launchIdle_Count_For_ThreadID(uint8_t concurrenctThreadID, uint32_t newValue)
    {
        auto temp = stat_get_ptr_list_Of_launchIdle_Count_For_ThreadID()->begin();
        std::advance(temp, concurrenctThreadID);
        *temp = newValue;
    }
    void OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtSERVER::LaunchEnableForConcurrentThreadsAt_SERVER_Control::stat_set_Item_On_list_Of_STATE_For_ConcurrentCore(uint8_t concurrenct_threadID, bool newState)
    {
        auto temp = stat_get_ptr_list_Of_STATE_For_ConcurrentCore()->begin();
        std::advance(temp, concurrenct_threadID);
        *temp = newState;
    }
    void OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtSERVER::LaunchEnableForConcurrentThreadsAt_SERVER_Control::stat_set_Item_On_list_for_Que_Of_CoreTolaunch(uint8_t slot, uint8_t concurrenct_threadID)
    {
        auto temp = stat_get_ptr_list_Of_Que_Of_CoreTolaunch()->begin();
        std::advance(temp, slot);
        *temp = concurrenct_threadID;
    }
    void OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtSERVER::LaunchEnableForConcurrentThreadsAt_SERVER_Control::stat_set_new_concurrentCycle_Try_CoreId_Index(uint32_t newValue)
    {
