...
namespace OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtSERVER
{
    ...
    public:
        ...
        void dyn_thread_Start(class LaunchEnableForConcurrentThreadsAt_SERVER_Framework* obj, uint8_t concurrentThreadID);
        void dyn_thread_End(class LaunchEnableForConcurrentThreadsAt_SERVER_Framework* obj, uint8_t concurrentThreadID);
        void dyn_initialise_Control(class LaunchEnableForConcurrentThreadsAt_SERVER_Framework* obj);
    ...
    private:
        ...
        static void stat_CLASS_create_ptr_LaunchConcurrency_Control(class LaunchEnableForConcurrentThreadsAt_SERVER_Framework* obj);
