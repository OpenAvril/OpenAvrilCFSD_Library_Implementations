...
// private.
    ...
    void OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Control::writeEnable_ShiftQueValues(OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Framework* obj, uint8_t coreId_A, uint8_t coreId_B)
    {
        ...
        // set.
    // static.
    void OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Control::create_flag_praisingWrite(bool* newDEFAULT_bool)
    {
        stat_set_flag_praisingWrite(newDEFAULT_bool);
        while (stat_get_ptr_flag_praisingWrite() == NULL) { }
    }
    void OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Control::create_list_Of_2ibt_flag_WriteState(std::array<bool, 2>* newDEFAULT_boolList)
    {
    ...
    void OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Control::create_list_Of_WriteActive_Count_For_ThreadId(uint32_t* newDEFAULT_uint32_t)
    {
    ...
    void OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Control::create_list_Of_WriteIdle_Count_For_ThreadId(uint32_t* newDEFAULT_uint32_t)
    {
    ...
    void OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Control::create_list_Of_WriteWait_Count_For_ThreadId(uint32_t* newDEFAULT_uint32_t)
    {
    ...
    void OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Control::create_new_writeCycle_Try_ThreadId_Index(uint8_t* newDEFAULT_uint8_t)
    {
        stat_set_new_writeCycle_Try_ThreadId_Index(*newDEFAULT_uint8_t);
        while (stat_get_ptr_new_writeCycle_Try_ThreadId_Index() == NULL) {}
    }
    void OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Control::create_QUE_List_Of_ThreadToWrite(uint8_t* newDEFAULT_uint8_t)
    {
    ...
    void OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Control::create_writeCycle_Try_ThreadId_Index(uint8_t* newDEFAULT_uint8_t)
    {
