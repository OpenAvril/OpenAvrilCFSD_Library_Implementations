...
namespace OpenAvrilCLIDWriteEnableForThreadsAtCLIENTOUTPUTRECIEVE
{
    ...
    public:
        ...
        ~WriteEnableForThreadsAt_CLIENTOUTPUTRECIEVE_Control();
        void app_writeEnable_Activate(class WriteEnableForThreadsAt_CLIENTOUTPUTRECIEVE_Framework* obj, uint8_t coreId);
        void app_writeEnable_SortQue(class WriteEnableForThreadsAt_CLIENTOUTPUTRECIEVE_Framework* obj);
        void app_writeEnable_Request(class WriteEnableForThreadsAt_CLIENTOUTPUTRECIEVE_Framework* obj, uint8_t coreId);
        void app_writeQue_Update(class WriteEnableForThreadsAt_CLIENTOUTPUTRECIEVE_Framework* obj);
        ...
        void writeEnable_ShiftQueValues(class WriteEnableForThreadsAt_CLIENTOUTPUTRECIEVE_Framework* obj, uint8_t coreId_A, uint8_t coreId_B);
