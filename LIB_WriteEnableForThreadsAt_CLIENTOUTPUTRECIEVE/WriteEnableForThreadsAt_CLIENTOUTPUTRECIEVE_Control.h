...
// public.
	...
	// dynamic.
        void dyn_writeEnable_Activate(class WriteEnableForThreadsAt_CLIENTOUTPUTRECIEVE_Framework* obj, uint8_t coreId);
        void dyn_writeEnable_SortQue(class WriteEnableForThreadsAt_CLIENTOUTPUTRECIEVE_Framework* obj);
        void dyn_writeEnable_Request(class WriteEnableForThreadsAt_CLIENTOUTPUTRECIEVE_Framework* obj, uint8_t coreId);
        void dyn_writeQue_Update(class WriteEnableForThreadsAt_CLIENTOUTPUTRECIEVE_Framework* obj);
        // create.    
