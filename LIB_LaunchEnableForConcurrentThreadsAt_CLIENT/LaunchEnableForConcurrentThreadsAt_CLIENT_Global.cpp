...
// pointers.
    // classes.
    // registers.
    bool* OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtCLIENT::LaunchEnableForConcurrentThreadsAt_CLIENT_Global::_ptr_flag_core_ACTIVE = NULL;
    bool* OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtCLIENT::LaunchEnableForConcurrentThreadsAt_CLIENT_Global::_ptr_flag_core_IDLE = NULL;
    uint8_t* OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtCLIENT::LaunchEnableForConcurrentThreadsAt_CLIENT_Global::_ptr_number_Implemented_Threads = NULL;
...
// private.
    ...
    void OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtCLIENT::LaunchEnableForConcurrentThreadsAt_CLIENT_Global::create_number_Implemented_Threads(uint8_t* newDEFAULT_Value)
    {
        ...
        // get.
    bool* OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtCLIENT::LaunchEnableForConcurrentThreadsAt_CLIENT_Global::stat_get_ptr_flag_core_ACTIVE()
    {
        return _ptr_flag_core_ACTIVE;
    }
    bool* OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtCLIENT::LaunchEnableForConcurrentThreadsAt_CLIENT_Global::stat_get_ptr_flag_core_IDLE()
    {
        return _ptr_flag_core_IDLE;
    }
    uint8_t* OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtCLIENT::LaunchEnableForConcurrentThreadsAt_CLIENT_Global::stat_get_ptr_number_Implemented_Threads()
    {
        return _ptr_number_Implemented_Threads;
    }
        // set.
    void OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtCLIENT::LaunchEnableForConcurrentThreadsAt_CLIENT_Global::stat_set_flag_core_ACTIVE(bool flag_core_ACTIVE)
    {
        *_ptr_flag_core_ACTIVE = flag_core_ACTIVE;
    }
    void OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtCLIENT::LaunchEnableForConcurrentThreadsAt_CLIENT_Global::stat_set_flag_core_IDLE(bool flag_core_IDLE)
    {
        *_ptr_flag_core_IDLE = flag_core_IDLE;
    }
    void OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtCLIENT::LaunchEnableForConcurrentThreadsAt_CLIENT_Global::stat_set_number_Implemented_Threads(uint8_t number_Implemented_Threads)
    {
