#include "pch.h"
    ...
    uint8_t* OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtCLIENT::LaunchEnableForConcurrentThreadsAt_CLIENT_Control::_stat_REG_ptr_concurrentCycle_Try_CoreId_Index = NULL;
    bool* OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtCLIENT::LaunchEnableForConcurrentThreadsAt_CLIENT_Control::_stat_REG_ptr_flag_praisinglaunch = NULL;
    std::list<uint32_t>* OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtCLIENT::LaunchEnableForConcurrentThreadsAt_CLIENT_Control::_stat_REG_ptr_list_Of_launchActive_Count_For_ThreadID = NULL;
    std::list<uint32_t>* OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtCLIENT::LaunchEnableForConcurrentThreadsAt_CLIENT_Control::_stat_REG_ptr_list_Of_launchIdle_Count_For_ThreadID = NULL;
    std::list<bool>* OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtCLIENT::LaunchEnableForConcurrentThreadsAt_CLIENT_Control::_stat_REG_ptr_list_Of_STATE_For_ConcurrentCore = NULL;
    std::list<uint8_t>* OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtCLIENT::LaunchEnableForConcurrentThreadsAt_CLIENT_Control::_stat_REG_ptr_list_for_Que_Of_CoreTolaunch = NULL;
    uint8_t* OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtCLIENT::LaunchEnableForConcurrentThreadsAt_CLIENT_Control::_stat_REG_ptr_new_concurrentCycle_Try_CoreId_Index = NULL;
    ...
    void OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtCLIENT::LaunchEnableForConcurrentThreadsAt_CLIENT_Control::dyn_REG_initialise_concurrentCycle_Try_CoreId_Index(uint8_t* newINITIALISED_Value)
    {
        stat_REG_set_concurrentCycle_Try_CoreId_Index(*newINITIALISED_Value);
    }
    void OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtCLIENT::LaunchEnableForConcurrentThreadsAt_CLIENT_Control::dyn_REG_initialise_flag_praisinglaunch(bool* newINITIALISED_Flagbit)
    {
        stat_REG_set_flag_praisinglaunch(*newINITIALISED_Flagbit);
    }
    void OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtCLIENT::LaunchEnableForConcurrentThreadsAt_CLIENT_Control::dyn_REG_initialise_Item_On_list_Of_launchActive_Count_For_ThreadID(uint8_t concurrenctThreadID, uint32_t* newINITIALISED_Value)
    {
    ...
    void OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtCLIENT::LaunchEnableForConcurrentThreadsAt_CLIENT_Control::dyn_REG_initialise_Item_On_list_Of_launchIdle_Count_For_ThreadID(uint8_t concurrenctThreadID, uint32_t* newINITIALISED_Value)
    {
        auto temp = stat_REG_get_ptr_list_Of_launchIdle_Count_For_ThreadID()->begin();
        std::advance(temp, concurrenctThreadID);
        *temp = *newINITIALISED_Value;
    }
    void OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtCLIENT::LaunchEnableForConcurrentThreadsAt_CLIENT_Control::dyn_REG_initialise_Item_On_list_Of_STATE_For_ConcurrentCore(uint8_t concurrenct_threadID, LaunchEnableForConcurrentThreadsAt_CLIENT_Global* ptr_Global)
    {
    ...
    void OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtCLIENT::LaunchEnableForConcurrentThreadsAt_CLIENT_Control::dyn_REG_initialise_new_concurrentCycle_Try_CoreId_Index(uint8_t* _new_concurrentCycle_Try_CoreId_Index)
    {
        stat_REG_set_new_concurrentCycle_Try_CoreId_Index(*_new_concurrentCycle_Try_CoreId_Index);
    }
    void OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtCLIENT::LaunchEnableForConcurrentThreadsAt_CLIENT_Control::dyn_REG_initialise_Item_On_list_Of_Que_Of_CoreTolaunch(uint8_t slotID)
    {
    ...
    void OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtCLIENT::LaunchEnableForConcurrentThreadsAt_CLIENT_Control::stat_REG_create_concurrentCycle_Try_CoreId_Index(uint8_t* newDEFAULT_Value)
    {
    ...
    void OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtCLIENT::LaunchEnableForConcurrentThreadsAt_CLIENT_Control::stat_REG_create_flag_praisinglaunch(bool* newDEFAULT_Flagbit)
    {
    ...
    void OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtCLIENT::LaunchEnableForConcurrentThreadsAt_CLIENT_Control::stat_REG_create_list_Of_launchActive_Count_For_ThreadID(uint32_t* newDEFAULT_Value)
    {
    ...
    void OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtCLIENT::LaunchEnableForConcurrentThreadsAt_CLIENT_Control::stat_REG_create_list_Of_launchIdle_Count_For_ThreadID(uint32_t* newDEFAULT_Value)
    {
    ...
    void OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtCLIENT::LaunchEnableForConcurrentThreadsAt_CLIENT_Control::stat_REG_create_list_Of_STATE_For_ConcurrentCore(bool* newDEFAULT_FlagBit)
    {
    ...
    void OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtCLIENT::LaunchEnableForConcurrentThreadsAt_CLIENT_Control::stat_REG_create_list_for_Que_Of_CoreTolaunch()
    {
        _stat_REG_ptr_list_Of_STATE_For_ConcurrentCore = new std::list<bool>(NULL);
    ...
    void OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtCLIENT::LaunchEnableForConcurrentThreadsAt_CLIENT_Control::stat_REG_create_new_concurrentCycle_Try_CoreId_Index(uint8_t* newDEFAULT_Value)
    {
