...
namespace OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtCLIENT
{
    ...
    public:
        ...
        void dyn_thread_Start(class LaunchEnableForConcurrentThreadsAt_CLIENT_Framework* obj, uint8_t concurrentThreadID);
        void dyn_thread_End(class LaunchEnableForConcurrentThreadsAt_CLIENT_Framework* obj, uint8_t concurrentThreadID);
        void dyn_initialise_Control(class LaunchEnableForConcurrentThreadsAt_CLIENT_Framework* obj);
    ...
    private:
        ...
        static void stat_CLASS_create_ptr_LaunchConcurrency_Control(class LaunchEnableForConcurrentThreadsAt_CLIENT_Framework* obj);
